...
SRC_URI_append_stm32mpcommon = " file://brcmfmac43430a0-sdio.txt "
SRC_URI_append_stm32mpcommon = " file://brcmfmac43430a0-sdio.bin "
...
do_install_append_stm32mpcommon() {
   ...
   install -m 0644 ${WORKDIR}/brcmfmac43430a0-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43430a0-sdio.myir,stm32mp157c-ya157c-v2.txt
...
FILES_${PN}-bcm43430_append_stm32mpcommon = " \
  ...
  ${nonarch_base_libdir}/firmware/brcm/brcmfmac43430a0-sdio.myir,stm32mp157c-ya157c-v2.txt \
