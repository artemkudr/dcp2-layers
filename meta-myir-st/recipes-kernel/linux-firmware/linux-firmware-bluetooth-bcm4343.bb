...
# local git
SRC_URI += " \
      git:///home/artem/MYIR/04_Sources/ya157c-yocto-stm32mp1-5.4.31-2.0.0/brcm;protocol=file;branch=develop"
...
do_install() {
    ...
    install -m 644 ${S}/BCM4343A0.hcd ${D}${nonarch_base_libdir}/firmware/brcm/BCM4343A0.hcd
